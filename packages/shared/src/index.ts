...
export const SUBSCRIPTION_PLANS = [
  {
    ...
    priceMonthly: 0,
    priceYearly: 0,
    features: ['20 free arcade classics', 'Daily rewards', 'Avatar + AI companion basics', 'Banner ads'],
  },
  {
    ...
    features: [
      'All free classics',
      '180+ premium originals (Story Mode + signatures)',
      'The Living World weekly events',
      'No ads · unlimited cloud saves',
      'Season Pass cosmetics track',
      'Full avatar & companion cosmetics',
    ],
  },
  {
