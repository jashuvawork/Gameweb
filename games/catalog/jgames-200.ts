...
export const SIGNATURE_ORIGINALS: CatalogGame[] = [
  ...
  {
    slug: 'temple-of-legends',
    title: 'Temple of Legends',
    description: 'Premium temple saga — deeper traps, lore chambers, and legendary artifacts.',
    genres: ['Puzzle', 'Adventure'],
    tags: ['temple', 'original', 'premium'],
    access: 'PREMIUM',
    creditCost: 0,
    engine: 'canvas',
  },
